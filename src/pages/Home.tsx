          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="text-center lg:text-left">
              <div className="inline-flex items-center px-4 py-2 bg-[#FFE5E5] rounded-full text-[#E53E3E] text-sm font-medium mb-6 animate-fade-in">
                ...
                Trusted by 1,000+ companies in Cambodia
              </div>
              
              <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold text-gray-900 leading-tight mb-6">
                Transform Your 
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#E53E3E] to-[#FF6B6B]"> Business</span>
              </h1>
              
              <p className="text-xl text-gray-600 mb-8 max-w-2xl leading-relaxed">
                We deliver innovative solutions that drive growth, efficiency, and success. Partner with us to unlock your company's full potential in today's digital landscape.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <div className="text-lg text-red-100 font-medium">Happy Clients</div>
            </div>
            <div className="text-center">
              <div className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-2">500+</div>
              <div className="text-lg text-red-100 font-medium">Projects Completed</div>
            </div>
            <div className="text-center">
              <div className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-2">15+</div>
              <div className="text-lg text-red-100 font-medium">Years Experience</div>
            </div>
            <div className="text-center">
              <div className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-2">99%</div>
              <div className="text-lg text-red-100 font-medium">Success Rate</div>
            </div>
          </div>
        </div>
      </section>
            ...
            <div className="flex flex-col md:flex-row items-center md:items-start space-y-6 md:space-y-0 md:space-x-8">
              ...
              <div className="flex-1 text-center md:text-left">
                ...
                <blockquote className="text-lg md:text-xl text-gray-700 leading-relaxed mb-6">
                  "InnovateCorp transformed our business operations completely. Their digital transformation strategy increased our efficiency by 200% and helped us scale globally."
                </blockquote>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            Join thousands of companies that have already transformed their operations with our innovative solutions.
          </p>
