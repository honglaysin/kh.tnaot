...
const ContactUsCN = () => {
  ...
  const validateForm = () => {
    ...
    if (!formData.message.trim()) newErrors.message = "请输入信息";
    setErrors(newErrors);
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-72 bg-gradient-to-br from-[#FFF5F5] via-white to-[#FFE5E5] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4">
          <h1 className="text-4xl md:text-5xl font-bold mb-2">联系我们</h1>
          <p className="text-lg md:text-xl text-gray-700">我们很乐意收到您的来信！如有任何问题或咨询，请随时联系我们。</p>
        </div>
      </section>
      ...
      <section className="py-20 px-4 md:px-8 lg:px-16 bg-gray-50">
        <div className="container mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16">
          {/* Form */}
          <div>
            <h2 className="text-3xl font-bold text-gray-900 mb-4">发送信息给我们</h2>
            <p className="text-gray-600 mb-8">请填写以下表格，我们会尽快回复您。</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <label htmlFor="name" className="block font-medium">姓名 *</label>
                  <input
                    id="name"
                    name="name"
                    value={formData.name}
              ...
              <div className="space-y-2">
                <label htmlFor="subject" className="block font-medium">主题 *</label>
                <input
                  id="subject"
                  name="subject"
              ...
              <div className="space-y-2">
                <label htmlFor="message" className="block font-medium">信息 *</label>
                <textarea
                  id="message"
                  name="message"
                  value={formData.message}
                  onChange={handleChange}
                  placeholder="请详细说明您的咨询..."
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
            {[
              { title: "客户服务", email: "support@tnaot.com", phone: "(+855) 023 922 788" },
              { title: "广告咨询", email: "chenghuyleng@kohthmey.net", phone: "(+855) 010 688 511" },
              { title: "商务合作", email: "chenghuyleng@kohthmey.net", phone: "(+855) 010 688 511" },
              { title: "招聘", email: "hr@kohthmey.net", phone: "Telegram : 015 856 322 / 061 538 022" },
            ].map((contact) => (
